...
public class PostRequest {
	...
	public static class CreatePost {
		...
		private List<@NotNull(message = "태그 ID는 null일 수 없습니다.") Long> tagIdList;

		@NotNull(message = "카테고리는 필수입니다.")
		private Long categoryId;

		public static CreatePost of(String title, String content, String thumbnailImage, List<Long> tagIdList,
			Long categoryId) {
			return CreatePost
				.builder()
				.title(title)
